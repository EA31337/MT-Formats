/**
 * MT4 structure SYMBOL (file format "symbols.raw")
 *
 * Symbols in a file are sorted by name. The symbol id has to be unique but neither to be ascending nor continuous.
 */
